...
export { RySwitch,RySelect,RyDivider,RyCheckbox,RyInput,RyCheckboxGroup,RyRadioGroup,  RyRadio,Icon,Ellipsis, Avatar, RyButton, RyTabs, RyTab, RyDialog, openDialog };

const components = [RyButton,RySelect,RyDivider,RyInput,RyCheckboxGroup,RyCheckbox,RyRadioGroup, RyRadio, Icon, Link, Ellipsis, Avatar, RySwitch, RyTabs, RyTab, RyDialog];
