...
export { RySwitch,RyRadioGroup,  RyRadio,Icon,Ellipsis, Avatar, RyButton, RyTabs, RyTab, RyDialog, openDialog };

const components = [RyButton,RyRadioGroup, RyRadio, Icon, Link, Ellipsis, Avatar, RySwitch, RyTabs, RyTab, RyDialog];
